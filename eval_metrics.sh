...
source /Users/shubhamphal/opt/anaconda3/etc/profile.d/conda.sh

BASE=`pwd`

# please specify the dataset you want to test here
#topicalchat_usr convai2_grade_transformer_generator dailydialog_grade_transformer_ranker empatheticdialogues_grade_transformer_ranker convai2_grade_dialogGPT convai2_grade_transformer_ranker dailydialog_grade_transformer_generator  empatheticdialogues_grade_transformer_generator
#convai2_grade_transformer_generator convai2_grade_dialogGPT convai2_grade_transformer_ranker

#convai2_grade_bert_ranker convai2_grade_dialogGPT convai2_grade_transformer_generator convai2_grade_transformer_ranker dailydialog_grade_transformer_ranker dailydialog_grade_transformer_generator empatheticdialogues_grade_transformer_ranker empatheticdialogues_grade_transformer_generator
DATA=( convai2_grade_bert_ranker convai2_grade_dialogGPT convai2_grade_transformer_generator convai2_grade_transformer_ranker dailydialog_grade_transformer_ranker dailydialog_grade_transformer_generator empatheticdialogues_grade_transformer_ranker empatheticdialogues_grade_transformer_generator )
